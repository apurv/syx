...
/***/ function(module, exports, __webpack_require__) {
	...
	var renderToMarkup = function renderToMarkup(alt, state, req, res) {
	  var markup = undefined,
	      content = undefined;
	  var location = new _historyLibCreateLocation2['default'](req.url);
	  alt.bootstrap(state);

	  (0, _reactRouter.match)({ routes: _routesJsx2['default'], location: location }, function (error, redirectLocation, renderProps) {
	    if (redirectLocation) res.redirect(301, redirectLocation.pathname + redirectLocation.search);else if (error) res.send(500, error.message);else if (renderProps == null) res.send(404, 'Not found');else content = _react2['default'].renderToString(_react2['default'].createElement(_reactRouter.RoutingContext, renderProps));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deprecate = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsApp = __webpack_require__(11);

	var _componentsApp2 = _interopRequireDefault(_componentsApp);

	var _componentsVote = __webpack_require__(201);

	var _componentsVote2 = _interopRequireDefault(_componentsVote);

	var _componentsAbout = __webpack_require__(210);
	...
	var _componentsLogout = __webpack_require__(214);

	var _componentsLogout2 = _interopRequireDefault(_componentsLogout);

	var _componentsDashboard = __webpack_require__(216);

	var _componentsDashboard2 = _interopRequireDefault(_componentsDashboard);

	var _storesUserStore = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _altAltContainer = __webpack_require__(12);
	...
	var _storesTopicStore = __webpack_require__(194);

	var _storesTopicStore2 = _interopRequireDefault(_storesTopicStore);

	var _componentsNavigation = __webpack_require__(198);
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        { stores: {
	            ...
	            TopicStore: _storesTopicStore2['default']
	          } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mixinContainer = __webpack_require__(186)
	var assign = __webpack_require__(188).assign
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("production" !== process.env.NODE_ENV) {
	  React.addons.Perf = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsUserActions = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsUserWebAPIUtils = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsTopicActions = __webpack_require__(195);

	var _actionsTopicActions2 = _interopRequireDefault(_actionsTopicActions);

	var _utilsImmutableHelpers = __webpack_require__(197);
	...
	var TopicStore = (function () {
	  ...
	  function TopicStore() {
	    ...
	    // Instance variables defined anywhere in the store will become the state. You can initialize these in the constructor and
	    // then update them directly in the prototype methods
	    this.topics = _immutable2['default'].OrderedMap({});
	    ...
	    // Remember: alt generates uppercase constants for us to reference
	    this.bindListeners({
	      handleIncrement: _actionsTopicActions2['default'].INCREMENT,
	      handleDecrement: _actionsTopicActions2['default'].DECREMENT,
	      handleCreate: _actionsTopicActions2['default'].CREATE,
	      handleDestroy: _actionsTopicActions2['default'].DESTROY,
	      handleTyping: _actionsTopicActions2['default'].TYPING
	    });
	  }
	  ...
	  _createClass(TopicStore, [{
	    key: 'bootstrap',
	    value: function bootstrap() {
	      if (!_immutable2['default'].OrderedMap.isOrderedMap(this.topics)) {
	        this.topics = (0, _utilsImmutableHelpers.fromJSOrdered)(this.topics);
	      }
	      this.newTopic = '';
	    }
	  }, {
	    key: 'handleIncrement',
	    value: function handleIncrement(id) {
	    ...
	    key: 'handleDecrement',
	    value: function handleDecrement(id) {
	      var topic = this.topics.get(id);
	      var count = topic.get('count');
	      this.topics = this.topics.set(id, topic.set('count', count - 1));
	      this.emitChange();
	    ...
	    value: function handleCreate(data) {
	      var id = data.id;
	      this.topics = this.topics.set(id, _immutable2['default'].fromJS(data));
	      this.emitChange();
	    }
	  }, {
	    key: 'handleDestroy',
	...
	exports['default'] = _altInstance2['default'].createStore(TopicStore, 'TopicStore');
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/tomproenza/Documents/Fullstack/Projects/syx/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TopicStore.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsTopicWebAPIUtils = __webpack_require__(196);

	var _utilsTopicWebAPIUtils2 = _interopRequireDefault(_utilsTopicWebAPIUtils);
	  ...
	  _createClass(TopicActions, [{
	    ...
	    value: function create(text) {
	      ...
	      if (text.trim().length > 0) {
	        ...
	        _utilsTopicWebAPIUtils2['default'].addTopic(data).done(function success() {
	    ...
	    value: function increment(id) {
	      ...
	      _utilsTopicWebAPIUtils2['default'].updateTopic({ id: id }, false, true);
	    }
	    ...
	    value: function decrement(id) {
	      ...
	      _utilsTopicWebAPIUtils2['default'].updateTopic({ id: id }, false, false);
	    }
	    ...
	    value: function destroy(id) {
	      ...
	      _utilsTopicWebAPIUtils2['default'].deleteTopic({ id: id });
	    }
	...
	exports['default'] = _altInstance2['default'].createActions(TopicActions);
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/tomproenza/Documents/Fullstack/Projects/syx/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TopicActions.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = {
	   ...
	   */
	  updateTopic: function updateTopic(topic, isFull, isIncrement) {
	    var data = merge(topic, {
	      isFull: isFull,
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/tomproenza/Documents/Fullstack/Projects/syx/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TopicWebAPIUtils.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scssComponents_navigation = __webpack_require__(199);
...
/***/ function(module, exports) {
	...
	module.exports = {
		"navigation": "navigation__EK6BI",
		"navigation__item": "navigation__item__175YA",
		"navigation__item--logo": "navigation__item--logo__24L8U",
		"navigation__item--active": "navigation__item--active__31TWo"
	};
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Vote, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_componentsEntryBox2['default'], { topic: this.props.TopicStore.newTopic }),
	        _react2['default'].createElement(_componentsMainSection2['default'], { topics: this.props.TopicStore.topics }),
	        _react2['default'].createElement(_componentsScoreboard2['default'], { topics: this.props.TopicStore.topics })
	      );
	    }
	  }]);
	...
	Vote.propTypes = {
	  TopicStore: _react2['default'].PropTypes.object
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsTopicTextInput = __webpack_require__(203);

	var _componentsTopicTextInput2 = _interopRequireDefault(_componentsTopicTextInput);

	var _scssComponents_entrybox = __webpack_require__(204);
	...
	var EntryBox = (function (_React$Component) {
	  ...
	  function EntryBox() {
	    ...
	    this._onSave = function (text) {
	      _actionsTopicActions2['default'].create(text);
	    };

	    this._onChange = function (text) {
	      _actionsTopicActions2['default'].typing(text);
	    };
	  }
	  ...
	  _createClass(EntryBox, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_componentsTopicTextInput2['default'], { className: _scssComponents_entrybox2['default'].entrybox__input, value: this.props.topic, placeholder: 'What\'s yer fav idea?', onChange: this._onChange, onSave: this._onSave })
	      );
	    }
	  }]);
	...
	EntryBox.propTypes = { topic: _react2['default'].PropTypes.string };
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/tomproenza/Documents/Fullstack/Projects/syx/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TopicTextInput.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports) {
	...
	module.exports = {
		"entrybox": "entrybox__3fcTl",
		"entrybox__header": "entrybox__header__14rz6",
		"entrybox__input": "entrybox__input__fJA8T"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsTopicItem = __webpack_require__(206);

	var _componentsTopicItem2 = _interopRequireDefault(_componentsTopicItem);
	...
	var MainSection = (function (_React$Component) {
	  ...
	  _createClass(MainSection, [{
	    key: 'render',
	    value: function render() {
	      var topics = this.props.topics.toKeyedSeq().map(function (topic, key) {
	        return _react2['default'].createElement(_componentsTopicItem2['default'], { id: key, key: key, text: topic.get('text') });
	      }).toArray();
	      return _react2['default'].createElement(
	        'div',
	...
	MainSection.propTypes = { topics: _react2['default'].PropTypes.instanceOf(_immutable2['default'].OrderedMap) };
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopicItem = (function (_React$Component) {
	  ...
	  function TopicItem() {
	    ...
	    _get(Object.getPrototypeOf(TopicItem.prototype), 'constructor', this).apply(this, arguments);

	    this._onIncrement = function () {
	      _actionsTopicActions2['default'].increment(_this.props.id);
	    };

	    this._onDecrement = function () {
	      _actionsTopicActions2['default'].decrement(_this.props.id);
	    };

	    this._onDestroyClick = function () {
	      _actionsTopicActions2['default'].destroy(_this.props.id);
	    };
	  }
	  ...
	  _createClass(TopicItem, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'li',
	        { className: _scssComponents_vote2['default']['topic-item'], key: this.props.id },
	        _react2['default'].createElement(
	          'span',
	          { className: _scssComponents_vote2['default']['topic-item__topic'] },
	          this.props.text
	        ),
	        _react2['default'].createElement(
	          'button',
	          { className: _scssComponents_vote2['default']['topic-item__button'] + ' ' + _scssComponents_vote2['default']['topic-item__button--increment'], onClick: this._onIncrement },
	          '+'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { className: _scssComponents_vote2['default']['topic-item__button'] + ' ' + _scssComponents_vote2['default']['topic-item__button--decrement'], onClick: this._onDecrement },
	          '-'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { className: _scssComponents_vote2['default']['topic-item__button'] + ' ' + _scssComponents_vote2['default']['topic-item__button--destroy'], onClick: this._onDestroyClick },
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/tomproenza/Documents/Fullstack/Projects/syx/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TopicItem.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports) {
	...
	module.exports = {
		"entrybox": "entrybox__eFN1W",
		"entrybox__header": "entrybox__header__1-7oB",
		"entrybox__input": "entrybox__input__mvQyS",
		"vote": "vote__2qSTo",
		"main-section": "main-section__lCWFx",
		"main-section__header": "main-section__header__3FtEX",
		"main-section__list": "main-section__list__1eNt3",
		"topic-item__topic": "topic-item__topic__13Jil",
		"topic-item__button": "topic-item__button__Z9jOK",
		"topic-item__button--increment": "topic-item__button--increment__2TWq6",
		"topic-item__button--decrement": "topic-item__button--decrement__FzDk-",
		"topic-item__button--destroy": "topic-item__button--destroy__1XnAD",
		"scoreboard": "scoreboard__24efQ",
		"scoreboard__header": "scoreboard__header__2KsV7",
		"scoreboard__list": "scoreboard__list__3-hTq",
		"scoreboard__topic": "scoreboard__topic__2guou",
		"scoreboard__count": "scoreboard__count__3027z"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsTopicCountItem = __webpack_require__(209);

	var _componentsTopicCountItem2 = _interopRequireDefault(_componentsTopicCountItem);
	...
	var Scoreboard = (function (_React$Component) {
	  ...
	  _createClass(Scoreboard, [{
	    key: 'render',
	    value: function render() {
	      var topicListItems = this.props.topics.toKeyedSeq().map(function (topic, key) {
	        return _react2['default'].createElement(_componentsTopicCountItem2['default'], { key: key, title: topic.get('text'), count: topic.get('count') });
	      }).toArray();
	      return _react2['default'].createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopicCountItem = (function (_React$Component) {
	  _inherits(TopicCountItem, _React$Component);

	  function TopicCountItem() {
	    _classCallCheck(this, TopicCountItem);

	    _get(Object.getPrototypeOf(TopicCountItem.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(TopicCountItem, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'li',
	...
	exports['default'] = TopicCountItem;
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/tomproenza/Documents/Fullstack/Projects/syx/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TopicCountItem.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scssComponents_about = __webpack_require__(211);
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          'Ninja Ocean is comprised of a team of passionate developers, hackers & scientists, aimed to do good.'
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	module.exports = {
		"about": "about__RmFVf",
		"about__header": "about__header__1P5Lm",
		"about__description": "about__description__29FJC"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scssComponents_login = __webpack_require__(213);
	        ...
	        if (this.state.user.get('isWaiting')) {
	          ...
	          renderedResult = _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                'a',
	                { className: _scssComponents_login2['default'].login__button + ' ' + _scssComponents_login2['default']['login__button--green'], href: '/auth/google' },
	                'Login with Google'
	              )
	            )
	          );
...
/***/ function(module, exports) {
	...
	module.exports = {
		"login__header": "login__header__3heW5",
		"login__fieldset": "login__fieldset__aOAkx",
		"login__input": "login__input__UhVd2",
		"login__button": "login__button__31Bth",
		"login__button--green": "login__button--green__2v7GU",
		"login__hint": "login__hint__tPoJA"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scssComponents_logout = __webpack_require__(215);
...
/***/ function(module, exports) {
	...
	module.exports = {
		"logout__header": "logout__header__3KwCO"
	};
